...
Button(accueil, text="S'jhkhkh", width=20, fg="red", font=("Condensed Italic", 20, "bold"), cursor="hand",command=pageUser.seconMenuPrinci).grid(row=0, column=3, padx=0 , pady=20, ipady=10)

frame =Frame(accueil, width=1500,height=900, bg="#61d2ff", ).grid(row=1, column=0, columnspan=2, padx=200, pady=30)

img = ImageTk.PhotoImage(Image.open("/Users/imac-05/Desktop/projetTkinter/hospi.jpeg"))
img_label=Label(frame, image= img, width=1500, height=900).grid(row=1, column=0,columnspan=2)
